...
const overview = [
  "Product — Built a research-driven mobile app to improve parent-child communication in Type 1 diabetes care.",
  "Role — Led front-end delivery on a 5-person team and translated UX research into production-ready screens.",
  "Impact — Accelerated pilot readiness through iterative feedback from children and parents.",
];
...
const highlightGroups = [
  {
    ...
    items: [
      ...
      "Cross-functional ownership — Partnered with design + research to iterate quickly.",
    ],
  },
  {
    title: "Leadership",
    items: [
      ...
      "Adaptability — Expanded front-end ownership while maintaining delivery momentum.",
    ],
  },
];
...
const outcomes = [
  "Scalability — Established a production-ready front-end foundation for continued feature delivery.",
      ...
      <main className="mx-auto max-w-4xl px-5 pb-20 pt-14 sm:px-8 lg:px-12">
        ...
        <header className="mt-6 space-y-4 rounded-3xl border border-[#e6d8c8] bg-[#fffbf7]/95 p-8 shadow-lg shadow-[#2e1c10]/10 backdrop-blur dark:border-[#3b2a1f] dark:bg-black">
          <div className="flex flex-wrap items-center gap-3 text-xs font-semibold text-[#5a4030] dark:text-white">
            <span className="rounded-full bg-[#f6ebdf] px-3 py-1 text-[#2e1c10] dark:bg-[#121212] dark:text-white">React Native</span>
            <span className="rounded-full bg-[#f6ebdf] px-3 py-1 text-[#2e1c10] dark:bg-[#121212] dark:text-white">TypeScript</span>
            <span className="rounded-full bg-[#f6ebdf] px-3 py-1 text-[#2e1c10] dark:bg-[#121212] dark:text-white">Firebase</span>
            <span className="rounded-full bg-[#f6ebdf] px-3 py-1 text-[#2e1c10] dark:bg-[#121212] dark:text-white">OpenAI</span>
            <span className="rounded-full bg-[#f6ebdf] px-3 py-1 text-[#2e1c10] dark:bg-[#121212] dark:text-white">UX Design &amp; Research</span>
          </div>
          <div className="space-y-3">
            ...
            <p className="text-base leading-7 text-[#5a4030] dark:text-white">
              A collaborative mobile app for families navigating Type 1 diabetes, designed to improve parent-child communication through a research-backed, user-centered experience.
            </p>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              <div className="overflow-hidden rounded-2xl border border-[#e6d8c8] bg-[#fffdf9] shadow-sm dark:border-[#3b2a1f] dark:bg-black">
                <Image src={codiHome} alt="Codi home screen" className="h-full w-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-2xl border border-[#e6d8c8] bg-[#fffdf9] shadow-sm dark:border-[#3b2a1f] dark:bg-black">
                <Image src={codiHistory} alt="Codi history screen" className="h-full w-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-2xl border border-[#e6d8c8] bg-[#fffdf9] shadow-sm dark:border-[#3b2a1f] dark:bg-black">
                <Image src={codiSummaryLog} alt="Codi summary log activity screen" className="h-full w-full object-cover" />
              </div>
            </div>
          </div>
        </header>
        ...
        <section className="mt-6 space-y-4 rounded-3xl border border-[#e6d8c8] bg-[#fffbf7]/95 p-8 shadow-inner shadow-[#2e1c10]/6 dark:border-[#3b2a1f] dark:bg-black">
          ...
          <div className="space-y-4">
            <div className="mx-auto w-full max-w-[520px] overflow-hidden rounded-2xl border border-[#e6d8c8] bg-[#fffdf9] shadow-sm dark:border-[#3b2a1f] dark:bg-black">
              <video className="h-full w-full" controls playsInline preload="metadata">
                <source src="/codi/codi-log-demo.mp4" type="video/mp4" />
              </video>
            </div>
